...
\begin{tabular}[c]{@{}l@{}}Data Science (Search Experience and Recommendation),\\ Daraz\textendash Alibaba Group Inc.,\\ Karachi, Pakistan.\end{tabular} & 
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ & 
\begin{tabular}[c]{@{}l@{}}
...
\begin{tabular}[l]{@{}l@{}}2018 -- cont.\\\end{tabular} & 
\begin{tabular}[l]{@{}l@{}}
...
\begin{tabularx}{\textwidth}{cX}
01/22 – to date & 
Senior Data Scientist (for Search Experience and Recommendation) at Daraz--Alibaba Group, Karachi
\\\\
02/21 – 01/22 & 
Principal R\emph{\&}D Engineer (for NLP) at Love For Data, Karachi
\\\\
01/17 – 12/21 & 
Senior Lecturer at Dept. of Computer Science, Mohammad Ali Jinnah University, Karachi
\\\\
01/19 – 12/19 & 
AI/Software Developer at AskIQ, Karachi, Pakistan
\\\\
01/16 – 03/17 & Data Scientist at Cubix Co., Karachi, Pakistan\\\\
06/13 – 12/16 & Lecturer at CoC\&IS, Karachi Institute of Economics \& Technology, Karachi, Pakistan\\\\
02/12 – 06/13 & Software Engineer II at Mazik Global, Karachi, Pakistan -cum- Microsoft Inc., Renton, USA\\\\
01/11 – 02/12 & Web+iOS App. Developer  at Counterpoint, Karachi, Pakistan -cum- Qurtaba LLC., Fremont, USA
\end{tabularx}
...
\subsection*{Teaching}
\begin{tabularx}{\textwidth}{cX}
2017 – 2021 & Courses taught to \emph{grad students} at MAJU: CS6420 Applied Programming; CS5510 Advanced Research Method, CS6610 Information Retrieval Techniques.
...
Since $2018$ (and as of December '21), there are $66$ citations with $h$-index = $5$. The Q* statistic of journal articles is Q1=$2$, Q2=$1$, Q3=$4$ and Q4=$1$. Published items are sorted chronologically in reverse order. Conference papers that later converted into book chapters or journal articles are counted once.
\subsection*{Refereed Journal Articles}
\begin{enumerate}
\itemsep=.1em

\item Tafseer Ahemd, Muhammad Suffian, Muhammad Yaseen Khan, and Alessandro Bogliolo. ``Discovering Lexical Similarity Using Articulatory Feature-Based Phonetic Edit Distance.'' \emph{IEEE Access} (2021). {\scshape (Q1; \textsc{\bfseries \textsc{SCI-IF}} 3.36)} \href{https://doi.org/10.1109/ACCESS.2021.3137905}{\scshape\small [\textcolor{blue}{PDF}]}
...
\subsubsection*{{Conference and Workshop Attendee}}
\begin{enumerate}
\itemsep.1em
